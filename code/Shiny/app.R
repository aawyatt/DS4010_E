  ...
  dashboardSidebar(
    tags$head(
      tags$style(HTML("
        ...
        /* 2) Make input + button always fit sidebar */
        #chat_query,    /* the text field */ 
        #send_chat {    /* the actionButton */ 
          width: 80% !important;
          box-sizing: border-box;
        }
        #clear_chat {    /* the actionButton */ 
          width: 80% !important;
          box-sizing: border-box;
        }
        #chat_history p {
        ...
        /* 3) On very small screens, reduce button padding/font to avoid overlap */
...
server <- function(input, output, session) {
  ...
  ##=== CHATBOT INTEGRATION =====
  source("C:/Users/landa/Downloads/ChatBot.R")
  context_text <- readr::read_file("C:/Users/landa/Downloads/Context.txt")
