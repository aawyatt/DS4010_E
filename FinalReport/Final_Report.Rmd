...
library(dplyr)
library(tidyr)
df <- data.frame(read.csv("../data_folder/clean/CurrentDiningData.csv"))
...
$log(\mu_i)= \beta_0 + \beta_1MealPlan + \beta_2Semester+\beta_3Year+\beta_4UndergradCount$
...
This section summarizes the key takeaways from the project, including insights gained from the data analysis, dashboard development process, and skills acquired over the course of the semester.
